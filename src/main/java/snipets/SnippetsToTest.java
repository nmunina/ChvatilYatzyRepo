...
public class SnippetsToTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (gameRunning) {
			...
			if (choice2 == 1 && one > 0) {
				System.out.println("Pöang i ettor: " + (one * 1));
				tempScore += (one * 1);
				combinationScore[0] = (one * 1);
				combinationsChecked[0] = true;
			} else if (choice2 == 2 && two > 0) {

				System.out.println("Pöang i tvåor: " + (two * 2));
				tempScore += (two * 2);
				...
				System.out.println("Pöang i treor: " + (three * 3));
				tempScore += (three * 3);
				...
				System.out.println("Pöang i fyror: " + (four * 4));
				tempScore += (four * 4);
				...
				System.out.println("Pöang i femmor: " + (five * 5));
				tempScore += (five * 5);
				...
				System.out.println("Pöang i sexor: " + (six * 6));
				tempScore += (six * 6);
